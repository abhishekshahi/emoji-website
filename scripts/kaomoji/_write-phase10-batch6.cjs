...
fs.writeFileSync(path.join(root, "src/lib/kaomoji/kaomoji-phase10.test.ts"), `import assert from "node:assert/strict";
...
`, "utf8");
console.log("wrote kaomoji-phase10.test.ts");
