...
const finalJsonPath = join(exportDir, "manifests", "r2-phase-8-43-final.json");
...
const reportPath = join(exportDir, "PHASE-8.43-FINAL-REPORT.md");
...
async function main(): Promise<void> {
  ...
  console.log(`Phase 8.43: ${finalDecision} (${scoreCount}/12) — upload ${progress.done}/${EXPECTED_OBJECTS}`);
}
