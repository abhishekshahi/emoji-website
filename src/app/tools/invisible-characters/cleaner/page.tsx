...
import { InvisibleCharCleanerPanel } from "@/components/tools/invisible-char-cleaner-panel";
...
const PAGE = getInvisibleToolPage("cleaner")!;
...
export default function InvisibleCharCleanerPage() {
  return (
    <div className="page-shell space-y-8 pb-12">
      ...
      <InvisibleCharToolNav active="cleaner" />
      <InvisibleCharCleanerPanel />
    </div>
  );
}
