...
describe("phase 21 production qa launch", () => {
  ...
  it("5 public count 51338", () => assert.equal(m().data_counts.public, 51338));
  it("6 relationships 396162", () => assert.equal(m().data_counts.relationships, 396162));
  ...
  it("19 sitemap expected urls", () => assert.equal(m().seo.sitemap_expected_urls, 51338));
