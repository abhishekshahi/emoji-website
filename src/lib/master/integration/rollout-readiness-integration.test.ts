...
let rolloutPackageCache: ReturnType<typeof buildRolloutReadinessPackage> | undefined;

function rolloutPackage() {
  rolloutPackageCache ??= buildRolloutReadinessPackage(rootDir);
  return rolloutPackageCache;
}
